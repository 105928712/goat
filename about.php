    ...
    <main>
        ...
        <section class="panel">
            ...
            <dl>
                ...
                <dd>Joey managed our team. He managed our Jira project, the GitHub page, and completed apply.html. He contributed the main styling of all the pages using the colour palette provided by Sienna, creating default panels, navigation and footers for each page as well as using prior knowledge to create an enhanced end-user experience. Joey also aided every team member with their respective pages. Using Sienna's basis for a logo design, Joey created the logo's final design. He created settings.php and the process_eoi as well as the management portal, including sign in and registration functionality.</dd>
                <dt class="right">Sienna - 105914355</dt>
                <dd>Sienna was responsible for all content displayed to the user, from all content on index.html to the written job descriptions for jobs.html, as well as group information for about.html. She provided the colour scheme, the company name, and the basis for the company logo. She also completed and updated about.html/about.php, as well as created the table for jobs.php in the SQL database. For jobs.php, she used PHP to query the table from the database to propagate the job description panels dynamically. Sienna also wrote the content for the enhancements.php page and completed majority of the content from the PowerPoint Presentation.</dd>
